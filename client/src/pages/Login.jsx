...
function Login() {
  ...
  <div className='login_container my-auto sm:mt-16 mx-auto w-[clamp(400px,60vw,500px)] aspect-video flex flex-col shadow-lg bg-white p-[clamp(0.8rem,2vw,3rem)] rounded-sm'>
    ...
    <form action="" className='flex flex-col space-y-2 sm:space-y-3'>
      <input onChange={handlechange} name='name' type="text" placeholder='Username' className='w-full border border-slate-300  rounded-sm p-2'/>
      <input onChange={handlechange} name='email' type="text" placeholder='Email' className=' w-full border border-slate-300  rounded-sm p-2'/>
      <input onChange={handlechange} name='password' type="text" placeholder='Password' className='w-full border border-slate-300 rounded-sm p-2' />
